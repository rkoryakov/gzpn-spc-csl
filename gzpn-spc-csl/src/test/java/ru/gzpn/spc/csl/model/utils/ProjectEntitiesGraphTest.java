...
public class ProjectEntitiesGraphTest {

	@Test
	public void getPathBetweenNodesTest() {
		List<Entities> result = ProjectEntitiesGraph.getPathBetweenNodes(Entities.HPROJECT.getName(), Entities.WORK.getName());
	...
	public void getPathBetweenNodesTest2() {
		List<Entities> result = ProjectEntitiesGraph.getPathBetweenNodes(Entities.HPROJECT.getName(), Entities.STAGE.getName());
		assertThat(result).contains(Entities.HPROJECT, atIndex(0));
		assertThat(result).contains(Entities.CPROJECT, atIndex(1));
	...
	public void getPathBetweenNodesTest3() {
		List<Entities> result = ProjectEntitiesGraph.getPathBetweenNodes(Entities.WORK.getName(), Entities.HPROJECT.getName());
	...
	public void getPathBetweenNodesTest4() {
		List<Entities> result = ProjectEntitiesGraph.getPathBetweenNodes(Entities.CPROJECT.getName(), Entities.WORK.getName());
	...
	public void getPathBetweenNodesTest5() {
		List<Entities> result = ProjectEntitiesGraph.getPathBetweenNodes(Entities.HPROJECT.getName(), Entities.CPROJECT.getName());
		assertThat(result).contains(Entities.HPROJECT, atIndex(0));
		assertThat(result).contains(Entities.CPROJECT, atIndex(1));
	}
	...
	public void getPathBetweenNodesTest6() {
		List<Entities> result = ProjectEntitiesGraph.getPathBetweenNodes(Entities.STAGE.getName(), Entities.CPROJECT.getName());
	...
	public void getPathBetweenNodesTest7() {
		List<Entities> result = ProjectEntitiesGraph.getPathBetweenNodes(Entities.STAGE.getName(), Entities.STAGE.getName());
		assertThat(result).contains(Entities.STAGE, atIndex(0));
	}
}
