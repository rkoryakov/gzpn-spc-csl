...
//		result.add(root0);
	...
	public List<ColumnSettings> getDefaultColumns() {
		...
		result.add(new ColumnSettings(entityName, IContract.FIELD_ID, null, false, 0));
		result.add(new ColumnSettings(entityName, IContract.FIELD_NAME, null, true, 1));
		result.add(new ColumnSettings(entityName, IContract.FIELD_CODE, null, true, 2));
		result.add(new ColumnSettings(entityName, IContract.FIELD_EXECUTORNAME, null, true, 3));
		result.add(new ColumnSettings(entityName, IContract.FIELD_CUSTOMERNAME, null, true, 4));
		result.add(new ColumnSettings(entityName, IContract.FIELD_SIGNINGDATE, null, true, 5));
		
		result.add(new ColumnSettings(entityName, IContract.FIELD_CREATE_DATE, null, false, 6));
		result.add(new ColumnSettings(entityName, IContract.FIELD_CHANGE_DATE, null, false, 7));
